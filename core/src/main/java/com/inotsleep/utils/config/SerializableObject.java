...
public abstract class SerializableObject {
    ...
    public void serialize(MappingNode node) {
        ...
        afterSerialization(node);
    }

    public void deserialize(MappingNode node) {
        beforeDeserialization(node);
    ...
    protected void afterDeserialization(MappingNode node) {

    }

    protected void beforeSerialization(MappingNode node) {

    }

    protected void afterSerialization(MappingNode node) {
