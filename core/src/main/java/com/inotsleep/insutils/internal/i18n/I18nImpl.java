...
import com.inotsleep.insutils.internal.i18n.config.I18nConfig;
...
public class I18nImpl implements I18n {
    ...
    private I18nImpl(INSUtils plugin) {
        this.plugin = plugin;
        logger = LoggingManager.getPrefixedLogger("[I18n] ");
        instance = this;
    }

    public static I18nImpl getInstance() {
        return instance;
    }
    ...
    private void fetchTranslationFiles(I18nConsumer consumer) {
        if (consumer == null) {
            return;
        }
    ...
    private LangFile loadDefaultsFromPlugin(I18nConsumer plugin, String lang) {
        InputStream stream = plugin.getResource("lang/" + lang + ".yml");
        if (stream == null) return null;
        return new LangFile(stream);
    }

    private LangFile loadDefaultsFromAPI(I18nConsumer plugin, String lang) {
        return loadDefaultsFromAPI(plugin.getSlug(), lang);
    }

    private LangFile loadDefaultsFromAPI(String plugin, String lang) {
